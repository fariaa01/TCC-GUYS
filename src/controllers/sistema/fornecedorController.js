const Fornecedor = require('../../models/sistema/estoque/fornecedorModel');
...
module.exports = {
  listar: async (req, res, next) => {
    try {
      ...
      return res.render('sistema/dados-fornecedor', { fornecedores: fornecedores || [] });
    } catch (err) {
  ...
  detalhes: async (req, res, next) => {
    try{
      ...
      res.render('sistema/detalhes-fornecedor', { fornecedor, historicoCompras });
    }
    catch(err) {
